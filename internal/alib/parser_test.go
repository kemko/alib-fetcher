...
func Test_Parse_recognizes_publication_year_suffix_variants(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "suffix before page count", bibliography: "М., 2019 г 320 с.", year: 2019},
		{name: "suffix before text", bibliography: "М., 2019 г Твердый переплет", year: 2019},
		{name: "double suffix before text", bibliography: "М., 1954-2000 гг твердый переплет", year: 2000},
		{name: "nonbreaking suffix boundary", bibliography: "М., 1986 г\u00a0320 с.", year: 1986},
		{name: "newline suffix boundary", bibliography: "М., 1987 г\nТвердый переплет", year: 1987},
...
func Test_ParseWithResult_counts_malformed_announcement_without_buy_url_on_mixed_page(t *testing.T) {
	t.Parallel()
